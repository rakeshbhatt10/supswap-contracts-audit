...
import '@supswap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ISupV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function supV3SwapCallback(
        ...
        ISupV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ISupV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
