...
/// @title NFTSVG
/// @notice Provides a function for generating an SVG associated with a SUPNFT
library NFTSVG {
    ...
    function generateSVG(SVGParams memory params) internal pure returns (string memory svg) {
        ...
        msg: "Forged in SVG for SUPin 2021 by 0xe8ab59d3bcde16a29912de83a90eb39628cfc163",
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    generateSVGCardMode(params.quoteTokenSymbol, params.baseTokenSymbol, params.feeTier),
