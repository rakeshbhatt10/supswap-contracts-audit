...
import '@supswap/v3-core/contracts/interfaces/callback/ISupV3FlashCallback.sol';
...
/// @notice An example contract using the SUPV3 flash function
contract PairFlash is ISupV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `SUPV3FlashCallback`
